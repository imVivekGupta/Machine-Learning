...
def plot(insample_error,outsample_error):
	...
	plt.legend()
	plt.title('Error v/s iterations (Sigmoid A1)')
	plt.savefig('./result_files/plot_A1.png')
...
f = open('./result_files/a1_results.txt','w')
...
out = backprop('sigmoid',0.1,50000)							# run learning algorithm
